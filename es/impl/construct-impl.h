...
Handle<JSObject> Construct__Function(
  Error* e, Handle<FunctionObject> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__BindFunction(
  Error* e, Handle<BindFunctionObject> O, std::vector<Handle<JSValue>> extra_args
) {
...
Handle<JSObject> Construct__ArrayConstructor(
  Error* e, Handle<ArrayConstructor> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__BoolConstructor(
  Error* e, Handle<BoolConstructor> O, std::vector<Handle<JSValue>> arguments
) {
  bool b;
  if (arguments.size() == 0)
...
Handle<JSObject> Construct__ErrorConstructor(
  Error* e, Handle<ErrorConstructor> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__FunctionConstructor(
  Error* e, Handle<FunctionConstructor> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__NumberConstructor(
  Error* e, Handle<NumberConstructor> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__ObjectConstructor(
  Error* e, Handle<ObjectConstructor> O, std::vector<Handle<JSValue>> arguments
) {
...
Handle<JSObject> Construct__RegExpConstructor(
  Error* e, Handle<RegExpConstructor> O, std::vector<Handle<JSValue>> arguments
) {
  Handle<String> P, F;
  if (arguments.size() == 0) {
    P = String::Empty();
...
Handle<JSObject> Construct__StringConstructor(
  Error* e, Handle<StringConstructor> O, std::vector<Handle<JSValue>> arguments
) {
  if (arguments.size() == 0)
